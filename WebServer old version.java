...
public class WebServer extends NanoHTTPD {
   ...
   public void addWebListener(cloudstrike.WebServer.WebListener l) {
   ...
   protected void fireWebListener(String uri, String method, Properties header, Properties param, String desc, boolean primary, String response, long size) {
      ...
      while(i.hasNext()) {
         ((cloudstrike.WebServer.WebListener)i.next()).receivedClient(uri, method, header, param, desc, primary, response, size);
      }
      ...
      if (!useragent.startsWith("lynx") && !useragent.startsWith("curl") && !useragent.startsWith("wget")) {
         if (method.equals("OPTIONS")) {
            ...
            if (this.hooks.containsKey(uri)) {
               ...
               return service != null ? this.processResponse(uri, method, header, param, true, service, service.serve(uri, method, header, param)) : this.processResponse(uri, method, header, param, false, (WebService)null, new Response("404 Not Found", "text/html", CommonUtils.bString(CommonUtils.readResource("resources/404.html"))));
               ...
               do {
                  if (!i.hasNext()) {
                     ...
                     if (isStagerX64(uri)) {
                        ...
                        return this.processResponse(uri, method, header, param, false, (WebService)null, new Response("404 Not Found", "text/html", CommonUtils.bString(CommonUtils.readResource("resources/404.html"))));
                     }
